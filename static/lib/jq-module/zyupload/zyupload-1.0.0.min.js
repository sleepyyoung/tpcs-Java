    ...
    $.Jcrop = function (obj, opt) {
        ...
        var Coords = function () {
            ...
            function getFixed() {
                ...
                var aspect = options.aspectRatio, min_x = options.minSize[0] / xscale,
                    min_y = options.minSize[1] / yscale, max_x = options.maxSize[0] / xscale,
                    max_y = options.maxSize[1] / yscale, rw = x2 - x1, rh = y2 - y1, rwa = Math.abs(rw),
                    rha = Math.abs(rh), real_ratio = rwa / rha, xx, yy;
                if (max_x == 0) {
                    max_x = boundx * 10
                }
                if (max_y == 0) {
        ...
        var Selection = function () {
            ...
            function moveHandles(c) {
                var midvert = Math.round((c.h / 2) - hhs), midhoriz = Math.round((c.w / 2) - hhs),
                    north = west = -hhs + 1, east = c.w - hhs, south = c.h - hhs, x, y;
...
(function ($, undefined) {
    $.fn.zyPopup = function (options, param) {
        ...
        return this.each(function () {
            ...
            var tailorVal = {};
            var defaults = {
                src: "", index: 0, name: "", onTailor: function (val) {
                }
            };
            ...
            this.openPopup = function () {
                ...
                function render() {
                    var image = $(this), borderWidth = parseInt(zoomContent.css("borderLeftWidth")),
                        maxImageWidth = windowWidth - (borderWidth * 2),
                        maxImageHeight = windowHeight - (borderWidth * 2), imageWidth = image.width(),
    ...
    $.fn.zyUpload = function (options, param) {
        ...
        return this.each(function () {
            ...
            this.createPopupPlug = function (imgSrc, index, name) {
                $("body").zyPopup({
                    src: imgSrc, index: index, name: name, onTailor: function (val, quondamImgInfo) {
