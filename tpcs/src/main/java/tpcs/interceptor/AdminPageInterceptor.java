...
public class AdminPageInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (cookies != null) {
            for (Cookie cookie : cookies) {
                ...
                try {
                    ...
                    if (existingUser != null && existingUser.getStatus() == 0 && userService.isAdminByUsername(username)) {
                        return true;
                    }
        ...
        if (obj instanceof User) {
            ...
            if (existingUser != null && existingUser.getStatus() == 0 && userService.isAdminByUsername(user.getUsername())) {
                return true;
            }
        }
